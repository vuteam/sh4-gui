...
def DiskEntry(model, size, removable, rotational, internal):
	if not removable and internal and rotational:
		picture = LoadPixmap(cached = True, path = ("/usr/lib/enigma2/python/Blackhole/DeviceManager/icons/disk.png"))
	elif internal and not rotational:
		picture = LoadPixmap(cached = True, path = ("/usr/lib/enigma2/python/Blackhole/DeviceManager/icons/ssddisk.png"))
	else:
