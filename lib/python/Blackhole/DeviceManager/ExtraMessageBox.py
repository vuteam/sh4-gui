...
def MessageBoxEntry(name, picture):
	pixmap = LoadPixmap(cached = True, path = ("/usr/lib/enigma2/python/Blackhole/DeviceManager/icons/" + picture));
	if not pixmap:
		pixmap = LoadPixmap(cached = True, path = ("/usr/lib/enigma2/python/Blackhole/DeviceManager/icons/empty.png"));
